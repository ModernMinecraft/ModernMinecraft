...
import com.modernminecraft.common.ModernMinecraft;

public class BlockPlasticChest extends BlockContainer {

	public BlockPlasticChest (int id) {
        super(id, Material.wood);
        setHardness(2.0F);
        setResistance(5.0F);
        setUnlocalizedName("blockPC");
    ...
    player.openGui(ModernMinecraft.instance, 0, world, x, y, z);
            return true;
    }
